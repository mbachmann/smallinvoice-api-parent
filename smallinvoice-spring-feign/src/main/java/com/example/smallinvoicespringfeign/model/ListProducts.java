...
import com.example.smallinvoicespringfeign.model.ListProductsAllOf;
...
public class ListProducts  implements Serializable {
  ...
  public ListProducts pagination(ListPagination pagination) {
  ...
  */
  ...
  public ListProducts items(List<CatalogProductGET> items) {
    this.items = items;
    return this;
  }

  public ListProducts addItemsItem(CatalogProductGET itemsItem) {
    if (this.items == null) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    ListProducts listProducts = (ListProducts) o;
    return Objects.equals(this.pagination, listProducts.pagination) &&
        Objects.equals(this.items, listProducts.items);
  }
