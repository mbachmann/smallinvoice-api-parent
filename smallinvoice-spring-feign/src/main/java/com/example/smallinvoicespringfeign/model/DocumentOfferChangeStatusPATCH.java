...
public class DocumentOfferChangeStatusPATCH  implements Serializable {
  ...
  public DocumentOfferChangeStatusPATCH status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  */
  ...
  public DocumentOfferChangeStatusPATCH dateTime(LocalDateTime dateTime) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    DocumentOfferChangeStatusPATCH documentOfferChangeStatusPATCH = (DocumentOfferChangeStatusPATCH) o;
    return Objects.equals(this.status, documentOfferChangeStatusPATCH.status) &&
        Objects.equals(this.dateTime, documentOfferChangeStatusPATCH.dateTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class DocumentOfferChangeStatusPATCH {\n");
