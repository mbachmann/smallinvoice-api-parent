...
import com.example.smallinvoicespringfeign.model.ListContactsAllOf;
...
public class ListContacts  implements Serializable {
  ...
  public ListContacts pagination(ListPagination pagination) {
  ...
  */
  ...
  public ListContacts items(List<ContactGET> items) {
    this.items = items;
    return this;
  }

  public ListContacts addItemsItem(ContactGET itemsItem) {
    if (this.items == null) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pagination, listContacts.pagination) &&
