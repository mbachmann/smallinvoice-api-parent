...
public class DocumentLetterPOST  implements Serializable {
  ...
  public DocumentLetterPOST contactId(Integer contactId) {
  ...
  */
  ...
  public DocumentLetterPOST contactAddressId(Integer contactAddressId) {
  ...
  */
  ...
  public DocumentLetterPOST contactPrepageAddressId(Integer contactPrepageAddressId) {
  ...
  */
  ...
  public DocumentLetterPOST contactPersonId(Integer contactPersonId) {
  ...
  */
  ...
  public DocumentLetterPOST date(LocalDate date) {
    this.date = date;
    return this;
  }
  ...
  */
  ...
  public DocumentLetterPOST title(String title) {
    this.title = title;
    return this;
  }
  ...
  */
  ...
  public DocumentLetterPOST content(String content) {
  ...
  */
  ...
  public DocumentLetterPOST language(LanguageEnum language) {
  ...
  */
  ...
  public DocumentLetterPOST signatureId(Integer signatureId) {
  ...
  */
  ...
  public DocumentLetterPOST layoutId(Integer layoutId) {
  ...
  */
  ...
  public DocumentLetterPOST notes(String notes) {
    this.notes = notes;
    return this;
  }
  ...
  */
  ...
  public DocumentLetterPOST customFields(List<DescriptiveCustomFieldPOST> customFields) {
    this.customFields = customFields;
    return this;
  }

  public DocumentLetterPOST addCustomFieldsItem(DescriptiveCustomFieldPOST customFieldsItem) {
  ...
  */
  ...
  public DocumentLetterPOST freeTexts(List<DocumentFreeTextPOST> freeTexts) {
    this.freeTexts = freeTexts;
    return this;
  }

  public DocumentLetterPOST addFreeTextsItem(DocumentFreeTextPOST freeTextsItem) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    DocumentLetterPOST documentLetterPOST = (DocumentLetterPOST) o;
    return Objects.equals(this.contactId, documentLetterPOST.contactId) &&
        Objects.equals(this.contactAddressId, documentLetterPOST.contactAddressId) &&
        Objects.equals(this.contactPrepageAddressId, documentLetterPOST.contactPrepageAddressId) &&
        Objects.equals(this.contactPersonId, documentLetterPOST.contactPersonId) &&
        Objects.equals(this.date, documentLetterPOST.date) &&
        Objects.equals(this.title, documentLetterPOST.title) &&
        Objects.equals(this.content, documentLetterPOST.content) &&
        Objects.equals(this.language, documentLetterPOST.language) &&
        Objects.equals(this.signatureId, documentLetterPOST.signatureId) &&
        Objects.equals(this.layoutId, documentLetterPOST.layoutId) &&
        Objects.equals(this.notes, documentLetterPOST.notes) &&
        Objects.equals(this.customFields, documentLetterPOST.customFields) &&
        Objects.equals(this.freeTexts, documentLetterPOST.freeTexts);
  }
  ...
  public String toString() {
    ...
    sb.append("class DocumentLetterPOST {\n");
