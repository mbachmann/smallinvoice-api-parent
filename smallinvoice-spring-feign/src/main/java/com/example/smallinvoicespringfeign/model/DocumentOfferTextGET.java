...
public class DocumentOfferTextGET  implements Serializable {
  ...
  public DocumentOfferTextGET status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  */
  ...
  public DocumentOfferTextGET title(String title) {
    this.title = title;
    return this;
  }
  ...
  */
  ...
  public DocumentOfferTextGET introduction(String introduction) {
  ...
  */
  ...
  public DocumentOfferTextGET conditions(String conditions) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    DocumentOfferTextGET documentOfferTextGET = (DocumentOfferTextGET) o;
    return Objects.equals(this.status, documentOfferTextGET.status) &&
        Objects.equals(this.title, documentOfferTextGET.title) &&
        Objects.equals(this.introduction, documentOfferTextGET.introduction) &&
        Objects.equals(this.conditions, documentOfferTextGET.conditions);
  }
  ...
  public String toString() {
    ...
    sb.append("class DocumentOfferTextGET {\n");
