...
public class DocumentOrderConfirmationChangeStatusPATCH  implements Serializable {
  ...
  public DocumentOrderConfirmationChangeStatusPATCH status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  */
  ...
  public DocumentOrderConfirmationChangeStatusPATCH dateTime(LocalDateTime dateTime) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    DocumentOrderConfirmationChangeStatusPATCH documentOrderConfirmationChangeStatusPATCH = (DocumentOrderConfirmationChangeStatusPATCH) o;
    return Objects.equals(this.status, documentOrderConfirmationChangeStatusPATCH.status) &&
        Objects.equals(this.dateTime, documentOrderConfirmationChangeStatusPATCH.dateTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class DocumentOrderConfirmationChangeStatusPATCH {\n");
