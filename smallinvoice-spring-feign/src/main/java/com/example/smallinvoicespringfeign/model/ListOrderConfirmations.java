...
import com.example.smallinvoicespringfeign.model.ListOrderConfirmationsAllOf;
...
public class ListOrderConfirmations  implements Serializable {
  ...
  public ListOrderConfirmations pagination(ListPagination pagination) {
  ...
  */
  ...
  public ListOrderConfirmations items(List<DocumentOrderConfirmationGET> items) {
    this.items = items;
    return this;
  }

  public ListOrderConfirmations addItemsItem(DocumentOrderConfirmationGET itemsItem) {
    if (this.items == null) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    ListOrderConfirmations listOrderConfirmations = (ListOrderConfirmations) o;
    return Objects.equals(this.pagination, listOrderConfirmations.pagination) &&
        Objects.equals(this.items, listOrderConfirmations.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListOrderConfirmations {\n");
