...
import com.example.smallinvoicespringfeign.model.ListServicesAllOf;
...
public class ListServices  implements Serializable {
  ...
  public ListServices pagination(ListPagination pagination) {
  ...
  */
  ...
  public ListServices items(List<CatalogServiceGET> items) {
    this.items = items;
    return this;
  }

  public ListServices addItemsItem(CatalogServiceGET itemsItem) {
    if (this.items == null) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    ListServices listServices = (ListServices) o;
    return Objects.equals(this.pagination, listServices.pagination) &&
        Objects.equals(this.items, listServices.items);
  }
