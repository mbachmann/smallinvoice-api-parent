...
public class ListProductsCategories  implements Serializable {
  ...
  public ListProductsCategories pagination(ListPagination pagination) {
  ...
  */
  ...
  public ListProductsCategories items(List<CatalogCategoryGET> items) {
    this.items = items;
    return this;
  }

  public ListProductsCategories addItemsItem(CatalogCategoryGET itemsItem) {
    if (this.items == null) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    ListProductsCategories listProductsCategories = (ListProductsCategories) o;
    return Objects.equals(this.pagination, listProductsCategories.pagination) &&
        Objects.equals(this.items, listProductsCategories.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListProductsCategories {\n");
