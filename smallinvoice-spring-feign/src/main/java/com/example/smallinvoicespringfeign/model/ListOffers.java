...
import com.example.smallinvoicespringfeign.model.ListOffersAllOf;
...
public class ListOffers  implements Serializable {
  ...
  public ListOffers pagination(ListPagination pagination) {
  ...
  */
  ...
  public ListOffers items(List<DocumentOfferGET> items) {
    this.items = items;
    return this;
  }

  public ListOffers addItemsItem(DocumentOfferGET itemsItem) {
    if (this.items == null) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    ListOffers listOffers = (ListOffers) o;
    return Objects.equals(this.pagination, listOffers.pagination) &&
        Objects.equals(this.items, listOffers.items);
  }
