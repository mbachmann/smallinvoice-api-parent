...
public class DocumentTextPUT  implements Serializable {
  ...
  public DocumentTextPUT status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  */
  ...
  public DocumentTextPUT title(String title) {
    this.title = title;
    return this;
  }
  ...
  */
  ...
  public DocumentTextPUT introduction(String introduction) {
  ...
  */
  ...
  public DocumentTextPUT conditions(String conditions) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    DocumentTextPUT documentTextPUT = (DocumentTextPUT) o;
    return Objects.equals(this.status, documentTextPUT.status) &&
        Objects.equals(this.title, documentTextPUT.title) &&
        Objects.equals(this.introduction, documentTextPUT.introduction) &&
        Objects.equals(this.conditions, documentTextPUT.conditions);
  }
  ...
  public String toString() {
    ...
    sb.append("class DocumentTextPUT {\n");
