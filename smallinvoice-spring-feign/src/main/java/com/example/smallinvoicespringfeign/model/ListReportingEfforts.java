...
import com.example.smallinvoicespringfeign.model.ListReportingEffortsAllOf;
...
public class ListReportingEfforts  implements Serializable {
  ...
  public ListReportingEfforts pagination(ListPagination pagination) {
  ...
  */
  ...
  public ListReportingEfforts items(List<ReportingEffortGET> items) {
    this.items = items;
    return this;
  }

  public ListReportingEfforts addItemsItem(ReportingEffortGET itemsItem) {
    if (this.items == null) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    ListReportingEfforts listReportingEfforts = (ListReportingEfforts) o;
    return Objects.equals(this.pagination, listReportingEfforts.pagination) &&
        Objects.equals(this.items, listReportingEfforts.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListReportingEfforts {\n");
